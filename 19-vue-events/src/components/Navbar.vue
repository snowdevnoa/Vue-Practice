...
1. Events allow us to interact with users, in terms of vue it is also a way for components to communicate
with one another.

Only events we have used so far is the DOM events: on click event
 -->
