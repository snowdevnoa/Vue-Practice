  ...
  >
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        <!-- 8. Now we can replace the "pages" array in the for loop to the publishedPages to filter out -->
        <li
...
export default {
  ...
  /* 6. We need to filter what we have in the navbar, and the best way to do that is using the computed option*/
  computed: {
    /* 7. 
          We don't want to modify the pages array in anyway, instead we return an array that only has the published pages
    */
    publishedPages() {
